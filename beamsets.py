...
class beamset:
    ...
    def shift_and_copy_beamset(self,_vertices,_trusses, _level, _shift):
        delim="##"
        ...
        for v in self.vertices:
            ...
            _vertices[str(last_vertex_id+1)]=vertices.vertex(str(last_vertex_id+1),new_coords)
            copied_vertex_ids.append(str(last_vertex_id+1))
            return_beamset.append_vertex(_vertices[str(last_vertex_id+1)])
            last_vertex_id+=1
