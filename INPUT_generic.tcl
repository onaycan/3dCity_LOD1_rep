...
#FREENODE
set FreeNodeID n;					#n ID: free node  to output results
#GROUNDNODES
...
node NodeID X Y Z
node NodeID X Y Z
#MASTERNODES     .... Geometrically center node on each Storey
...
element nonlinearBeamColumn ElementID NodeID NodeID 5 2 2
#BEAMLENGTH    .... 288 Zoll is normally used
set Beamlength_EltID LENGTH
set Beamlength_EltID LENGTH
set Beamlength_EltID LENGTH
set Beamlength_EltID LENGTH	
set Beamlength_EltID LENGTH
...
element nonlinearBeamColumn ElementID NodeID NodeID 5 1 1
#COLUMNLENGTH    ...  168 Zoll is normally used
set Columnlength_fix LENGTH    
#END
